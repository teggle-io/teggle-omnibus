...
Omnibus storage library with useful helpers for Storage patterns. You can use `Storage`
implementations in `omnibus-std`, or rely on these to remove some common
boilterplate.
